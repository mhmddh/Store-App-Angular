...
const routes: Routes = [
  ...
  { path: 'admin/products/product/edit/:idProduct', canActivate: [AuthGuard], component: ProductPageDetailComponent },
  { path: 'admin/brands/brand/edit/:idBrand', canActivate: [AuthGuard], component: BrandPageDetailComponent },
  { path: 'admin/categories/category/edit/:idCategory', canActivate: [AuthGuard], component: CategoryPageDetailComponent },
